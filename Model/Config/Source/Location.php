...
class Location implements ArrayInterface
{
    ...
    const ALLPAGE_PAGE_BOTTOM     = 'allpage.page-bottom';
    ...
    const HOMEPAGE_PAGE_BOTTOM    = 'cms_index_index.page-bottom';
    ...
    const CATEGORY_PAGE_BOTTOM     = 'catalog_category_view.page-bottom';
    ...
    const PRODUCT_PAGE_BOTTOM     = 'catalog_product_view.page-bottom';
